...
import game.base.item.base.model.*;
...
public enum ItemType {
    ...
    private int typeId;
    // 道具类
    private Class<? extends game.base.item.base.model.AbstractItem> typeClass;

    ItemType(int typeId, Class<? extends game.base.item.base.model.AbstractItem> typeClass) {
        this.typeId = typeId;
